...
class LatticeSecurityTracker:
    ...
    def _ensure_path_validation_tracker(self):
        ...
        if self.path_validation_tracker is None:
            from pyfromscratch.barriers.path_validation import PathValidationTracker
    ...
    def handle_call_post(
        ...
        from pyfromscratch.barriers.path_validation import detect_startswith_validation, detect_abspath_check
