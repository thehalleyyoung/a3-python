...
Scan poetry (dependency management) and fastapi (web framework) to expand tier 3 diversity.
...
REPOS = [
    {
        "name": "poetry",
        "path": Path("results/public_repos/clones/poetry"),
        "output": Path("results/public_repos/poetry_tier3_scan_iter148.json"),
        "description": "Dependency management and packaging tool"
    },
    {
        "name": "fastapi",
        "path": Path("results/public_repos/clones/fastapi"),
        "output": Path("results/public_repos/fastapi_tier3_scan_iter148.json"),
...
def main():
    print("Iteration 148: Poetry and FastAPI Tier 3 Scan")
    print("Expanding tier 3 diversity with dependency management and web framework repos")
