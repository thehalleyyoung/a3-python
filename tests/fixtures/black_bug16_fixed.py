"""Fixed version of black gen_python_files_in_dir (black#16).

The fix: child.resolve().relative_to(root) is wrapped in try/except
ValueError, and symlinks pointing outside the root are gracefully
ignored.
"""
import re
