"""Fixed version of cookiecutter hooks.py (bug #4).

The fix: run_script() checks the exit code from proc.wait() and raises
FailedHookException on non-zero status instead of returning the exit code.
"""
...
def run_script(script_path, cwd='.'):
    """Execute a script and raise on failure."""
